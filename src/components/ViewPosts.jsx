...
const ViewPosts = () => {
  const posts = [
    { id: 1, community: 'Cultivating Colony', content: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Odit reprehenderit labore molestias tenetur doloremque quas eligendi, rerum culpa consequatur ratione sed nesciunt facere laudantium at magnam recusandae similique! Repellat, libero!' },
    { id: 2, community: 'Ploughshare Society', content: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Odit reprehenderit labore molestias tenetur doloremque quas eligendi, rerum culpa consequatur ratione sed nesciunt facere laudantium at magnam recusandae similique! Repellat, libero!' },
    { id: 3, community: 'Cultivating Colony', content: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Odit reprehenderit labore molestias tenetur doloremque quas eligendi, rerum culpa consequatur ratione sed nesciunt facere laudantium at magnam recusandae similique! Repellat, libero!' },
    { id: 4, community: 'Ploughshare Society', content: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Odit reprehenderit labore molestias tenetur doloremque quas eligendi, rerum culpa consequatur ratione sed nesciunt facere laudantium at magnam recusandae similique! Repellat, libero!' },
  ];
        ...
        <div className='w-60 bg-slate-200'>
          <ul className='text-sm text-green-800 py-4'>
            ...
            <ul className={`bg-slate-200 w-max text-xs ml-4 ${isBookmark ? "block" : "hidden"}`}>
              <li className='rounded-lg my-4 px-3 py-2 font-light' style={{ background: "#FFE0B2" }}>Cultivating Colony</li>
              <li className='rounded-lg my-4 px-3 py-2 font-light' style={{ background: "#FFE0B2" }}>Harvest Hive</li>
              <li className='rounded-lg my-4 px-3 py-2 font-light' style={{ background: "#FFE0B2" }}>Humidity Watchout</li>
              <li className='rounded-lg my-4 px-3 py-2 font-light' style={{ background: "#FFE0B2" }}>Everything Agro</li>
              <li className='rounded-lg my-4 px-3 py-2 font-light' style={{ background: "#FFE0B2" }}>Ploughshare Society</li>
            </ul>

            <li className={`mb-2 w-full  px-4 py-2 ${isThread ? "bg-slate-300" : ""} cursor-pointer`} onClick={toggleThreads}>My Threads</li>
            <ul className={`bg-slate-200 w-max text-xs ml-4 ${isThread ? "block" : "hidden"}`}>
              <li className='rounded-lg my-4 px-3 py-2 font-light' style={{ background: "#FFE0B2" }}>Cultivating Colony</li>
              <li className='rounded-lg my-4 px-3 py-2 font-light' style={{ background: "#FFE0B2" }}>Harvest Hive</li>
              <li className='rounded-lg my-4 px-3 py-2 font-light' style={{ background: "#FFE0B2" }}>Humidity Watchout</li>
              <li className='rounded-lg my-4 px-3 py-2 font-light' style={{ background: "#FFE0B2" }}>Everything Agro</li>
            ...
            <li className={`mb-2 w-full  px-4 py-2 ${isCommunity ? "bg-slate-300" : ""} cursor-pointer`} onClick={toggleCommunity}>
              <span>My Communities</span>
            </li>
            <ul className={`bg-slate-200 w-max text-xs ml-4 ${isCommunity ? "block" : "hidden"}`}>
              <li className='rounded-lg my-4 px-3 py-2 font-light' style={{ background: "#FFE0B2" }}>Cultivating Colony</li>
              <li className='rounded-lg my-4 px-3 py-2 font-light' style={{ background: "#FFE0B2" }}>Harvest Hive</li>
              <li className='rounded-lg my-4 px-3 py-2 font-light' style={{ background: "#FFE0B2" }}>Humidity Watchout</li>
              <li className='rounded-lg my-4 px-3 py-2 font-light' style={{ background: "#FFE0B2" }}>Everything Agro</li>
                ...
                <div className="text-xs flex gap-2 items-center justify-between">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className='flex items-center relative'>
                      <button className="flex items-center" onClick={() => toggleOptions(index)}>
                        <img src={option} alt="" />
                      </button>
                      {isOptionsOpen[index] && (
                        <ul className={`shadow-md bg-slate-200 text-sm self-start rounded-md absolute top-6 right-2 ${
                            isOptionsOpen[index] ? "block" : "hidden"
                          } bg-white sm:translate-x-0 dark:border-gray-700`}>
                          <li className='border-b border-green-800 px-3 py-1'>Bookmark</li>
                    ...
                    <div className="flex items-center gap-2">
                      <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_324_192)">
                          <path d="M15.4818 7.83C14.8937 6.30882 13.8727 4.99331 12.5452 4.04604C11.2176 3.09878 9.64149 2.56129 8.01175 2.5C6.38201 2.56129 4.80594 3.09878 3.47835 4.04604C2.15076 4.99331 1.12983 6.30882 0.54175 7.83C0.502034 7.93985 0.502034 8.06015 0.54175 8.17C1.12983 9.69118 2.15076 11.0067 3.47835 11.954C4.80594 12.9012 6.38201 13.4387 8.01175 13.5C9.64149 13.4387 11.2176 12.9012 12.5452 11.954C13.8727 11.0067 14.8937 9.69118 15.4818 8.17C15.5215 8.06015 15.5215 7.93985 15.4818 7.83ZM8.01175 12.5C5.36175 12.5 2.56175 10.535 1.54675 8C2.56175 5.465 5.36175 3.5 8.01175 3.5C10.6618 3.5 13.4618 5.465 14.4768 8C13.4618 10.535 10.6618 12.5 8.01175 12.5Z" fill="#858585"/>
                          <path d="M8.01172 5C7.41838 5 6.83836 5.17595 6.34501 5.50559C5.85166 5.83524 5.46714 6.30377 5.24008 6.85195C5.01302 7.40013 4.95361 8.00333 5.06936 8.58527C5.18512 9.16721 5.47084 9.70176 5.8904 10.1213C6.30996 10.5409 6.84451 10.8266 7.42645 10.9424C8.00839 11.0581 8.61159 10.9987 9.15977 10.7716C9.70795 10.5446 10.1765 10.1601 10.5061 9.66671C10.8358 9.17336 11.0117 8.59334 11.0117 8C11.0117 7.20435 10.6957 6.44129 10.133 5.87868C9.57043 5.31607 8.80737 5 8.01172 5ZM8.01172 10C7.61616 10 7.22948 9.8827 6.90058 9.66294C6.57168 9.44318 6.31534 9.13082 6.16396 8.76537C6.01259 8.39991 5.97298 7.99778 6.05015 7.60982C6.12732 7.22186 6.3178 6.86549 6.59751 6.58579C6.87721 6.30608 7.23358 6.1156 7.62154 6.03843C8.0095 5.96126 8.41163 6.00087 8.77709 6.15224C9.14254 6.30362 9.4549 6.55996 9.67466 6.88886C9.89442 7.21776 10.0117 7.60444 10.0117 8C10.0117 8.53043 9.80101 9.03914 9.42593 9.41421C9.05086 9.78929 8.54215 10 8.01172 10Z" fill="#858585"/>
                        </g>
                        <defs>
                      ...
                      <svg width="19" height="18" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <defs>
                          <clipPath id="clip0_324_201">
                            <rect width="18" height="18" fill="white" transform="translate(0.0117188)"/>
                          </clipPath>
                        </defs>
                      </svg>
